...
//        profileUpdate.put("Date of Birth", "1990-12-31");
//        CleverTapAPI.getDefaultInstance(getApplicationContext()).profile.push(profileUpdate);
        ...
        String name = getTextFromInputEditText(R.id.Name_edit_text);
        String email = getTextFromInputEditText(R.id.Email_edit_text);

        HashMap<String, Object> profileUpdate = new HashMap<String, Object>();
        profileUpdate.put("Name", name);    // Name
        profileUpdate.put("Email", email);  // Email
